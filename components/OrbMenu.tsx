...
const OrbMenu: React.FC<OrbMenuProps> = ({ onSave, lastSavedTimestamp }) => {
    ...
    return (
        <div className="fixed bottom-4 left-4 z-50">
            {isOpen && (
                <div className="mb-3 p-3 bg-[var(--card-bg)] backdrop-blur-xl border border-[var(--neon-purple)] rounded-lg shadow-2xl neon-glow-purple flex flex-col gap-2 w-48 animate-fade-in-up">
                    <button
                    ...
                    <button
                        ...
                        className="flex items-center gap-3 w-full p-2 text-left text-sm text-gray-500 cursor-not-allowed"
                    >
                        <span className="font-mono text-xs text-[var(--neon-blue)]">Memo</span>
                        <span>Page Memo</span>
                    </button>
